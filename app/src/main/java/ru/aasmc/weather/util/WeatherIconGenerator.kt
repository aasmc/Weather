...
object WeatherIconGenerator {
    /**
     * Dynamically sets the [WeatherIconView] depending on the weather
     * condition received.
     */
    fun getIconResources(context: Context, iconView: WeatherIconView, cond: String?) {
        cond?.let { condition ->
            when {
